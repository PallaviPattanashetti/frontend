...
export default function HelpSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full max-w-[1160px] border-4 border-black flex flex-col md:flex-row items-center justify-center md:justify-between p-6 md:px-10 rounded-xl gap-8 mb-12"
      ...
      >
        ...
        >
          <img src={topSectionImages[0]} alt="Get Help" className="w-full h-[140px] object-cover" />
        ...
        >
          <img src={topSectionImages[1]} alt="Offer Help" className="w-full h-[140px] object-cover" />
          <div className="grow flex items-center justify-center bg-[#6F7887]/80 border-t-2 border-black font-bold uppercase text-black">
            Offer Help
          </div>
        </motion.div>
          ...
          >
            ...
            <div className="p-4 flex flex-col items-center justify-between grow">
              ...
              <motion.button
                ...
                className={`w-[190px] h-[60px] border-[3px] border-black rounded-2xl text-black font-bold text-[36px] flex items-center justify-center ${
