        ...
        {!isSuccess ? (
          <div className="w-full max-w-154 flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <label className="text-black font-bold ml-1 text-sm md:text-base">
                From
              </label>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="w-full h-15.5 bg-white/95 border border-gray-300 flex items-center justify-between px-4 rounded-lg shadow-md">
                ...
                <div className="flex items-center gap-6 font-bold text-xl md:text-2xl">
                  <button className="text-green-600 hover:scale-110 active:scale-95 transition-all">
                    +
                  </button>
                  <button className="text-red-600 hover:scale-110 active:scale-95 transition-all">
                    −
                  </button>
                </div>
              </div>
            ...
            <button
              ...
              className="mt-4 w-full h-15.5 bg-[#5F4F4F]/50 text-white font-bold rounded-xl hover:bg-gray-800 transition-colors uppercase tracking-widest"
            >
              Transfer Credits
            </button>
          </div>
