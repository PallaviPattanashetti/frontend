...
export default function ChatPage() {
  ...
  const contacts = [
    { id: 1, name: "Jose", status: "Online", avatar: "JS" },
    { id: 2, name: "Vanessa", status: "Away", avatar: "VN" },
    { id: 3, name: "Anna", status: "Online", avatar: "AN" },
  ];
    ...
    >
      ...
      <div className="w-full max-w-225 h-150 border border-gray-200  bg-[#28a8af]/42  flex flex-col md:flex-row shadow-xl rounded-2xl overflow-hidden">
        ...
        <div className="w-full md:w-72 border-b md:border-b-0 md:border-r border-gray-100 bg-gray-50/50 p-4 overflow-y-auto">
          <h2 className="text-gray-400 font-semibold text-xs uppercase tracking-wider mb-4 px-2">Contacts</h2>
          <div className="flex flex-col gap-1">
            {contacts.map((person) => (
              ...
              >
                <div className={`w-9 h-9 rounded-full flex items-center justify-center font-bold text-xs ${selectedPerson === person.name ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-500"}`}>
                  {person.avatar}
                </div>
